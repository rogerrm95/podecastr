...
import 'rc-slider/assets/index.css' // CSS - Slider //
        ...
        <div className={styles.playerContainer}>
            ...
            <footer className={!episode ? styles.empty : ''}>
                <div className={styles.progress}>
                    <span>{convertSecondToHours(progress)}</span>
                    ...
                    <span>{convertSecondToHours(episode?.duration ?? 0)}</span>
                </div>
                ...
                <div className={styles.buttons}>
                    ...
                    <button type='button' disabled={!episode || !hasPrevious} onClick={playPrevious}>
                        <img src="/play-previous.svg" alt="Retroceder" />
                    </button>
                ...
                {episode && (
                    ...
                    //                        onEnded={() => playNext(episodeList, currentEpisodeIndex)}
                    />
                )}
            </footer>
        </div>
